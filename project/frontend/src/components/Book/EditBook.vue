                    ...
                    <div class="card-body">
                        ...
                        <form @submit="onSubmit">
                            ...
                            <div class="from-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" placeholder="Titulo" name="title" class="from-control" v-model.trim="form.title">
                                </div>
                            </div>
                            ...
                            <div class="from-group row">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="description" class="from-control" placeholder="Descripcion" rows="3" v-model.trim="form.description"></textarea>
                                </div>
                            </div>
                            <div class="rows">
                                <div class="col text-left">
